...
class AtomicalsTransferBlueprintBuilder:
  ...
  def __calculate_output_blueprint_nfts(self, nft_atomicals, atomicals_spent_at_inputs, operations_found_at_inputs, sort_fifo):
  ...
  def __calculate_output_blueprint_fts(self, ft_atomicals, atomicals_spent_at_inputs, operations_found_at_inputs, sort_fifo):
