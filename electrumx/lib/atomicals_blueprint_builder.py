...
def calculate_outputs_to_color_for_ft_atomical_ids(tx, ft_atomicals, target_exponent, sort_by_fifo) -> FtColoringSummary:
    ...
    for item in atomical_list:
      ...
      if cleanly_assigned and len(expected_outputs) > 0:
        ...
        potential_atomical_ids_to_output_idxs_map[atomical_id] = ExpectedOutputSet(expected_outputs, use_exponent)
      else:
...
class AtomicalsTransferBlueprintBuilder:
  ...
  def color_ft_atomicals_regular(cls, ft_atomicals, tx, sort_fifo):
      output_colored_map = {}
      ft_coloring_summary = calculate_outputs_to_color_for_ft_atomical_ids(tx, ft_atomicals, -1, sort_fifo)
  ...
  def color_ft_atomicals_substantiate(cls, ft_atomicals, operations_found_at_inputs, tx):
      ...
      output_colored_map = {}
      ft_coloring_summary = calculate_outputs_to_color_for_ft_atomical_ids(tx, ft_atomicals, target_exponent, True)
      if not ft_coloring_summary: 
        return AtomicalFtOutputBlueprintAssignmentSummary({}, {}, True, None) 
  ...
  def are_payments_satisfied(self, expected_payment_outputs):
    ...
    ft_coloring_summary = calculate_outputs_to_color_for_ft_atomical_ids(self.tx, self.ft_atomicals, target_exponent, self.sort_fifo)
    output_idx_to_atomical_id_map = build_reverse_output_to_atomical_id_map(ft_coloring_summary.atomical_id_to_expected_outs_map)
