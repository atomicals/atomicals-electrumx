...
class HttpHandler(object):
    ...
    async def get_transaction_detail(self, txid, height=None, tx_num=-1):
        ...
        blueprint_builder = AtomicalsTransferBlueprintBuilder(self.logger, False, atomicals_spent_at_inputs, operation_found_at_inputs, tx_hash, tx, self.session_mgr.bp.get_atomicals_id_mint_info, True)
