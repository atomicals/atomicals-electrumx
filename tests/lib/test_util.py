...
from electrumx.lib import tx, util
...
def test_protocol_version():
    ...
    assert util.protocol_version(["0.9", "1.0"], (1, 0), (1, 1)) == ((1, 0), (0, 9))
    assert util.protocol_version(["0.9", "1.1"], (1, 0), (1, 1)) == ((1, 1), (0, 9))
    assert util.protocol_version(["1.1", "0.9"], (1, 0), (1, 1)) == (None, (1, 1))
    assert util.protocol_version(["0.8", "0.9"], (1, 0), (1, 1)) == (None, (0, 8))
    assert util.protocol_version(["1.1", "1.2"], (1, 0), (1, 1)) == ((1, 1), (1, 1))
    assert util.protocol_version(["1.2", "1.3"], (1, 0), (1, 1)) == (None, (1, 2))
...
def test_pack_varint():
    ...
    assert util.pack_varint(2**64 - 1) == b"\xff\xff\xff\xff\xff\xff\xff\xff\xff"
