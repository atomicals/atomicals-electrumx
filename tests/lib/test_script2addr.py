...
def test_get_address_from_output_script():
    ...
    addr_from_script = lambda script: get_address_from_output_script(
    ...
    assert "bc1zw508d6qejxtdg4y5r3zarvaryvaxxpcs" == addr_from_script(
    ...
    # base58 p2sh
    assert "35ZqQJcBQMZ1rsv8aSuJ2wkC7ohUCQMJbT" == addr_from_script(
        "a9142a84cf00d47f699ee7bbc1dea5ec1bdecb4ac15487"
    )
    assert "3PyjzJ3im7f7bcV724GR57edKDqoZvH7Ji" == addr_from_script(
