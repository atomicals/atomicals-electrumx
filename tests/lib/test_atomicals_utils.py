...
def test_calculate_expected_bitwork_base():
    ...
    assert(calculate_expected_bitwork('abcd', 0, 1000, 1) == 'abcd')
    assert(calculate_expected_bitwork('abcd', 1, 1000, 1) == 'abcd')
    assert(calculate_expected_bitwork('abcd', 999, 1000, 1) == 'abcd')
    assert(calculate_expected_bitwork('abcd', 1000, 1000, 1) == 'abcd.1')
    assert(calculate_expected_bitwork('abcd', 1001, 1000, 1) == 'abcd.1')
    assert(calculate_expected_bitwork('abcd', 1999, 1000, 1) == 'abcd.1')
    assert(calculate_expected_bitwork('abcd', 2000, 1000, 1) == 'abcd.2')
    assert(calculate_expected_bitwork('abcd', 15999, 1000, 1) == 'abcd.15')
    assert(calculate_expected_bitwork('abcd', 16000, 1000, 1) == 'abcd0')
    assert(calculate_expected_bitwork('abcd', 16001, 1000, 1) == 'abcd0')
    assert(calculate_expected_bitwork('abcdef', 32000, 1000, 1) == 'abcdef')
    assert(calculate_expected_bitwork('abcdefe', 32001, 1000, 2) == 'abcdefe0')
    assert(calculate_expected_bitwork('abcdefe', 33000, 1000, 2) == 'abcdefe0.2')
    assert(calculate_expected_bitwork('abcdefe', 33000, 1000, 3) == 'abcdefe000.3')
