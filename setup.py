...
setuptools.setup(
    ...
    extras_require={
        ...
        'rocksdb': ['Cython>=3.0,<3.1', 'rocksdb @ git+https://github.com/jansegre/python-rocksdb@6177a68'],
    ...
    download_url=('https://github.com/atomicals/atomicals-electrumx/archive/'
                  f'{version}.tar.gz'),
    classifiers=[
